  ...
  <s:layout-component name="body"> 
    ...
    <d:table name="${actionBean.contacts}" id="contact" requestURI="" defaultsort="1"> 
      ...
      <d:column title="Action"> 
        ...
        <s:link beanclass="stripesbook.action.ContactFormActionBean" event="form">
          <s:param name="contactId" value="${contact.id}"/>
          Update 
        </s:link> |
        <s:link beanclass="stripesbook.action.ContactListActionBean" event="delete" onclick="return confirm('Delete ${contact}?');">
          <s:param name="contactId" value="${contact.id}"/> 
          Delete 
        </s:link>
      </d:column> 
